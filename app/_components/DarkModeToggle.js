...
export default function DarkModeToggle() {
  ...
  return (
    <Switch
      ...
      className="group relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-background transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 data-[checked]:bg-background"
    >
      ...
      <span className="pointer-events-none relative inline-block size-5 transform rounded-full shadow ring-0 transition duration-200 ease-in-out group-data-[checked]:translate-x-5">
        ...
        >
          <svg
            className="swap-on fill-current w-6 h-6 text-slate-900"
